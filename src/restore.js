...
export var Inputs;
(function (Inputs) {
    Inputs["VariantInstallFromGithub"] = "install-from-github";
    Inputs["DontDoConfig"] = "dont-do-config"; // Input for cache, restore action
})(Inputs || (Inputs = {}));
export function utilsGetInputAsBool(name, options) {
...
async function installCcacheWindows() {
    ...
    if (variantInstallFromGithub) {
        ...
        `${process.env.VCPKG_INSTALLATION_ROOT}\\`, "ccache.exe");
    }
    else {
...
async function installSccacheWindows() {
    ...
    if (variantInstallFromGithub) {
        ...
        `${process.env.VCPKG_INSTALLATION_ROOT}\\`, "sccache.exe");
    }
    else {
