...
[ -d /usr/lib/sccache/ ] && set -x ; ls -latr /usr/lib/sccache/
[ -d /usr/local/lib/sccache/ ] && set -x ; ls -latr /usr/local/lib/sccache/
[ "$DEBUG" != "" ] && [ -d /usr/local/bin/ ] && set -x ; ls -latr /usr/local/bin/ 
